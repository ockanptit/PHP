...
<pre>
    Vấn đề 1: Chuyển định dạng thời gian timestamp về định dạng
    thời gian đọc được
...
<pre>
    Vấn đề 2: Chuyển đội ngược lại dạng thời gian date() về dạng timestamp
    GIẢI QUYẾT: dùng hàm strtotime()
    hàm này sẽ chuyển đổi 1 số chuỗi thành thời gian timestamp
    nhưng hàm này lại chỉ hỗ trợ 1 số kiểu định dạng thời gian như
    2019-01-31: Y-m-d
    31-01-2019: d-m-Y
    Nếu không phải kiểu định dạng thời gian như trên thì n sẽ trả về false
...
<pre>
    ...
    echo "<br> mktime(05, 54, 30, 02, 17, 2019)"  .mktime(05, 54, 30, 02, 17, 2019);
    ?>
</body>
</html>